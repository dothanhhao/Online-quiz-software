				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li><a href='<s:url value="TDTTesting/login"/>'>Đăng nhập</a></li>
								<li><a href='<s:url value="TDTTesting/login"/>'>Đăng ký</a></li>
							</ul>
						</div>
		...
		<!--//header-w3l-->
			<!--/banner-info-->
			   <div class="baner-info">
				  ...
				  <a class="hvr-rectangle-out w3_play_icon1" href='<s:url value="TDTTesting/login"/>' >Tham gia ở đây</a>
			   </div>
			<!--/banner-ingo-->		
		</div> 
    </div>
			...
			<div class="agileits-banner-grids text-center">
				<div class="banner-bottom-girds">
					<div class="agileits-banner-grid bg-w3ls-active">
						...
						<!-- <a class="hvr-rectangle-out w3_play_icon1" href="#" data-toggle="modal" data-target="#myModal"> Bắt đầu thi</a> -->
					</div>
  ...
  <div class="agileits-services w3ls-section" id="agileits-services" >
		<div class="container">
			...
			<div class="agileits-services-row">
				...
				<a href='<s:url value="TDTTesting/login"/>'>
